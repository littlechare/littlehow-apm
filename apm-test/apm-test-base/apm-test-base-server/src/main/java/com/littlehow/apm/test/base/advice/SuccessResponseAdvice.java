 ...
 * @author littlehow
 **/
@ControllerAdvice(basePackages = "com.littlehow.apm.test")
public class SuccessResponseAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        if (body instanceof BaseResult) {
            return ((BaseResult) body).setTraceId(MDC.get(Span.TRACE_ID_NAME));
            ...
            return JSONObject.toJSONString(BaseResult.success(body).setTraceId(MDC.get(Span.TRACE_ID_NAME)));
        }
        return BaseResult.success(body).setTraceId(MDC.get(Span.TRACE_ID_NAME));
